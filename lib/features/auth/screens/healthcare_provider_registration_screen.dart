...
class _HealthcareProviderRegistrationScreenState
        ...
        child: Column(
          ...
          children: [
            ...
            _buildGlassTextField(
              ...
              onChanged: (value) {
                setState(() {
                  // Trigger rebuild when email text changes
                });
              },
              validator: (value) {
                if (value == null || value.trim().isEmpty) {
    ...
    return Column(
      ...
      children: [
        ...
        Container(
          ...
          child: Row(
            children: [
              Icon(Icons.info_outline, color: const Color(0xFF4FC3A1)),
              const SizedBox(width: 12),
              Expanded(
                child: Text(
                  'We sent a verification code to ${_emailController.text}. Please check your email and enter the code below.',
                  style: TextStyle(
        ...
        child: Row(
          children: [
            ...
            Radio<String>(
              ...
              activeColor: isSelected ? Colors.white : const Color(0xFF4FC3A1),
            ),
          ],
        ),
      ),
  ...
  Future<void> _sendVerificationEmail() async {
    ...
    try {
      // Generate a random 6-digit verification code (this will be sent to backend)
      ...
      final response = await http.post(
        Uri.parse('${ApiService.baseUrl}/healthcare/send-verification-email'),
  ...
  void _verifyEmailCode() async {
    ...
    try {
      final response = await http.post(
        Uri.parse('${ApiService.baseUrl}/healthcare/verify-email-code'),
        headers: {'Content-Type': 'application/json'},
        body: jsonEncode({
          'email': _emailController.text.trim().toLowerCase(),
