...
class _PrivacySecurityScreenState extends State<PrivacySecurityScreen> {
  ...
  Future<void> _loadUserInfo() async {
    ...
    try {
      _currentUserNic = await UserService.getUserNic();
    } catch (e) {
  ...
  Future<void> _changePassword() async {
    ...
    try {
      ...
      print('Debug: Changing password for NIC: $_currentUserNic');

      final response = await http.put(
        Uri.parse(
          '${ApiConfig.baseApiUrl}/auth/change-password/$_currentUserNic',
        ),
        ...
        children: [
          ...
          ListTile(
            ...
            onTap: () {
              ...
              // This is handled by the form being in the same screen
            },
          ),
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          Row(
            children: [
              Icon(Icons.privacy_tip, color: const Color(0xFF4FC3A1), size: 24),
              const SizedBox(width: 12),
              const Text(
                'Privacy Information',
                style: TextStyle(
          ...
          _buildInfoItem(
            ...
            description:
                'All medical information is kept confidential according to healthcare privacy standards.',
          ),
          ...
          _buildInfoItem(
            ...
            title: 'Support',
            description:
                'Contact our support team if you have any privacy concerns.',
          ),
        ],
      ),
    );
