...
import '../../../midwife/screens/baby_comprehensive_records_screen.dart';
import '../../../../models/baby.dart';

class DoctorBabySelectionScreen extends StatefulWidget {
  final Map<String, dynamic> motherData;

  const DoctorBabySelectionScreen({Key? key, required this.motherData})
    : super(key: key);

  @override
  State<DoctorBabySelectionScreen> createState() =>
      _DoctorBabySelectionScreenState();
}

class _DoctorBabySelectionScreenState extends State<DoctorBabySelectionScreen>
                ...
                child: Column(
                  ...
                  children: [
                        ...
                        Expanded(
                          child: Column(
                            ...
                            children: [
                              ...
                              Text(
                                'Mother: ${widget.motherData['fullName'] ?? 'Unknown'}',
                                style: const TextStyle(
                    ...
                    Container(
                      ...
                      child: Text(
                        '${babies.length} Baby${babies.length != 1 ? 's' : ''} Registered',
                        style: const TextStyle(
                          color: Colors.white,
                          fontSize: 14,
